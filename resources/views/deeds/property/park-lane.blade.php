...
@section('details')
    RENT—Site only @right('&#163;35')<br>
    @ditto('RENT') With 1 House @right('175')<br>
    @ditto('RENT') @ditto('With') 2 Houses @right('500')<br>
    @ditto('RENT') @ditto('With') 3 Houses @right('1100')<br>
    @ditto('RENT') @ditto('With') 4 Houses @right('1300')<br>
    @ditto('RENT') @ditto('With') HOTEL @right('1500')<br>
